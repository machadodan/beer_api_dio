...
public class SwaggerConfig {
    ...
    private static final String API_TITLE = "Beer Stck API";
    private static final String API_DESCRIPTION = "REST API for beer stock management";
    private static final String CONTACT_NAME = "Daniel Machado";
    private static final String CONTACT_GITHUB = "https://gtihub.com/machadodan";
